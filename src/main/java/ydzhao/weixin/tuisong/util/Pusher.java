...
public class Pusher {
     ...
     * 测试号的appId和secret
     */
//    private static String appId = "wx21b39f0b814a1ebd";
//    private static String secret = "fd64bc2deaeaddb7d876131101769c45";
    private static String appId = "wxbfac478ac570f8cf";
    private static String secret = "5a98705d2de186252098e1ce00ef285a";
    //模版id
    private static String templateId = "g0BzQ27A-0JWvguwHIh15lX9MlRjpSQVXrsMNwylfPc";
    ...
    public static void push(String openId){
        ...
        templateMessage.addData(new WxMpTemplateData("tuanju",JiNianRi.getTuanJu()+"","#FFA500"));
